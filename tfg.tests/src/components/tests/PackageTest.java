 ...
 * @generated
 */
public class PackageTest extends ClassifierTest {
	 ...
	 */
	@Override
	protected components.Package getFixture() {
		return (components.Package)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(ComponentsFactory.eINSTANCE.createPackage());
	}
