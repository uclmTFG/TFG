...
public class MofDiagramUpdater {
	...
	*/
	public static List<MofNodeDescriptor> getSemanticChildren(View view) {
		...
		case NodoUnoNodoUnoNodosDosCompartmentEditPart.VISUAL_ID:
			return getNodoUnoNodoUnoNodosDosCompartment_7001SemanticChildren(view);
		}
	...
	* @generated
	*/
	public static List<MofNodeDescriptor> getNodoUnoNodoUnoNodosDosCompartment_7001SemanticChildren(View view) {
		...
		NodoUno modelElement = (NodoUno) containerView.getElement();
		LinkedList<MofNodeDescriptor> result = new LinkedList<MofNodeDescriptor>();
		for (Iterator<?> it = modelElement.getNodosDos().iterator(); it.hasNext();) {
			NodoDos childElement = (NodoDos) it.next();
			int visualID = MofVisualIDRegistry.getNodeVisualID(view, childElement);
	...
	*/
	public static List<MofLinkDescriptor> getContainedLinks(View view) {
		...
		case NodoUnoEditPart.VISUAL_ID:
			return getNodoUno_2001ContainedLinks(view);
		case NodoDosEditPart.VISUAL_ID:
			return getNodoDos_2002ContainedLinks(view);
		case NodoDos2EditPart.VISUAL_ID:
			return getNodoDos_3001ContainedLinks(view);
	...
	*/
	public static List<MofLinkDescriptor> getIncomingLinks(View view) {
		switch (MofVisualIDRegistry.getVisualID(view)) {
		case NodoUnoEditPart.VISUAL_ID:
			return getNodoUno_2001IncomingLinks(view);
		case NodoDosEditPart.VISUAL_ID:
			return getNodoDos_2002IncomingLinks(view);
		case NodoDos2EditPart.VISUAL_ID:
			return getNodoDos_3001IncomingLinks(view);
		case EnlaceEditPart.VISUAL_ID:
	...
	*/
	public static List<MofLinkDescriptor> getOutgoingLinks(View view) {
		switch (MofVisualIDRegistry.getVisualID(view)) {
		case NodoUnoEditPart.VISUAL_ID:
			return getNodoUno_2001OutgoingLinks(view);
		case NodoDosEditPart.VISUAL_ID:
			return getNodoDos_2002OutgoingLinks(view);
		case NodoDos2EditPart.VISUAL_ID:
			return getNodoDos_3001OutgoingLinks(view);
		case EnlaceEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoUno_2001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoDos_2002ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoDos_3001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoUno_2001IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoDos_2002IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoDos_3001IncomingLinks(View view) {
		NodoDos modelElement = (NodoDos) view.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
		LinkedList<MofLinkDescriptor> result = new LinkedList<MofLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoUno_2001OutgoingLinks(View view) {
		NodoUno modelElement = (NodoUno) view.getElement();
		LinkedList<MofLinkDescriptor> result = new LinkedList<MofLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoDos_2002OutgoingLinks(View view) {
		NodoDos modelElement = (NodoDos) view.getElement();
		LinkedList<MofLinkDescriptor> result = new LinkedList<MofLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Enlace_4001(modelElement));
		return result;
	 ...
	 * @generated
	 */
	public static List<MofLinkDescriptor> getNodoDos_3001OutgoingLinks(View view) {
		NodoDos modelElement = (NodoDos) view.getElement();
		LinkedList<MofLinkDescriptor> result = new LinkedList<MofLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Enlace_4001(modelElement));
		return result;
