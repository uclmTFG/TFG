 ...
 * @generated
 */
public class AtributosMetodosNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AtributosMetodosNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.AtributosMetodos_2004, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.AtributosMetodosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
