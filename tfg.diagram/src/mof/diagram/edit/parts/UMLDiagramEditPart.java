...
import mof.diagram.edit.commands.MofCreateShortcutDecorationsCommand;
import mof.diagram.edit.policies.UMLDiagramCanonicalEditPolicy;
import mof.diagram.edit.policies.UMLDiagramItemSemanticEditPolicy;
...
public class UMLDiagramEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Mof"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UMLDiagramItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new UMLDiagramCanonicalEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(new MofCreateShortcutDecorationsCommand(getEditingDomain(),
