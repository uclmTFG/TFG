 ...
 * @generated
 */
public class NodoDosNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NodoDosNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.NodoDos_2003, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.NodoDosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
