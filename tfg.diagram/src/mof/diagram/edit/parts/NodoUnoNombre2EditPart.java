 ...
 * @generated
 */
public class NodoUnoNombre2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NodoUnoNombre2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.NodoUno_3002, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.NodoUnoNombre2EditPart.VISUAL_ID));
		}
		return parser;
	}
