 ...
 * @generated
 */
public class AtributosMetodosNombre2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AtributosMetodosNombre2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return MofElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.AtributosMetodos_3004, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.AtributosMetodosNombre2EditPart.VISUAL_ID));
		}
		return parser;
	}
