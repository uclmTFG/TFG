 ...
 * @generated
 */
public class PackageNombre2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PackageNombre2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.Package_3001, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.PackageNombre2EditPart.VISUAL_ID));
		}
		return parser;
	}
