...
import mof.diagram.edit.policies.MofTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EnlaceTextoEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(MofVisualIDRegistry.getType(mof.diagram.edit.parts.EnlaceTextoEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public EnlaceTextoEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new MofTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.Enlace_4001, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.EnlaceTextoEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, MofEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EnlaceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EnlaceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EnlaceLabelFigure() {
			this.setText("Enlace");
		}
