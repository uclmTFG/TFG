 ...
 * @generated
 */
public class NodoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NodoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.Nodo_2001, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.NodoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
