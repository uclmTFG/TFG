...
import mof.diagram.edit.policies.PackageItemSemanticEditPolicy;
...
public class PackageEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PackageNombreEditPart) {
			((PackageNombreEditPart) childEditPart).setLabel(getPrimaryShape().getFigurePackageLabelFigure());
			return true;
		}
		if (childEditPart instanceof PackagePackageNodosCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getPackageNodosCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PackagePackageNodosCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PackagePackageNodosCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getPackageNodosCompartmentFigure();
			pane.remove(((PackagePackageNodosCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PackagePackageNodosCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MofVisualIDRegistry.getType(PackageNombreEditPart.VISUAL_ID));
	}
