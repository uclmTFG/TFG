...
public class ClasNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.Clas_2001, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.ClasNameEditPart.VISUAL_ID));
		}
		return parser;
	}
