 ...
 * @generated
 */
public class PackageNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PackageNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MofParserProvider.getParser(MofElementTypes.Package_2001, getParserElement(),
					MofVisualIDRegistry.getType(mof.diagram.edit.parts.PackageNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
