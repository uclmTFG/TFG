 ...
 * @generated
 */
public class EnlaceCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return MofBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEnlace_4001(getContainer(), getSource(),
				getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Enlace newElement = MofFactory.eINSTANCE.createEnlace();
	...
	* @generated
	*/
	protected void doConfigure(Enlace newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
