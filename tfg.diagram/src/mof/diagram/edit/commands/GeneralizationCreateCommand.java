...
public class GeneralizationCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Nodeone) {
			return false;
		}
		if (target != null && false == target instanceof Nodeone) {
			return false;
		}
		if (getSource() == null) {
		...
		return MofBaseItemSemanticEditPolicy.getLinkConstraints().canCreateGeneralization_4001(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Generalization newElement = MofFactory.eINSTANCE.createGeneralization();
	...
	* @generated
	*/
	protected Nodeone getSource() {
		return (Nodeone) source;
	}

	/**
	* @generated
	*/
	protected Nodeone getTarget() {
