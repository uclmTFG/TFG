 ...
 * @generated
 */
public class PackagePackageNodosCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<MofNodeDescriptor> childDescriptors = MofDiagramUpdater
				.getPackagePackageNodosCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<MofNodeDescriptor> childDescriptors = MofDiagramUpdater
				.getPackagePackageNodosCompartment_7002SemanticChildren((View) getHost().getModel());
