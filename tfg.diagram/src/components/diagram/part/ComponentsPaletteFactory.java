...
<<<<<<< HEAD
		paletteContainer.add(createPackage8CreationTool());
	...
	*/
	private ToolEntry createAttribute1CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Attribute1CreationTool_title,
				Messages.Attribute1CreationTool_desc, Collections.singletonList(ComponentsElementTypes.Property_3003));
		entry.setId("createAttribute1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.Property_3003));
	...
	*/
	private ToolEntry createClas2CreationTool() {
		...
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Clas2CreationTool_title,
				Messages.Clas2CreationTool_desc, types);
		entry.setId("createClas2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.Clas_3002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createEnumLiteral3CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.EnumLiteral3CreationTool_title,
				...
				Collections.singletonList(ComponentsElementTypes.EnumLiteral_3009));
		entry.setId("createEnumLiteral3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.EnumLiteral_3009));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createEnumeration4CreationTool() {
		...
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.Enumeration_3008));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createInterface5CreationTool() {
		...
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.Interface_3006));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createNote6CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Note6CreationTool_title,
				Messages.Note6CreationTool_desc, Collections.singletonList(ComponentsElementTypes.Note_2005));
		entry.setId("createNote6CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.Note_2005));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createOperation7CreationTool() {
		...
		types.add(ComponentsElementTypes.Method_3007);
		...
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.Method_3004));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	* @generated
	*/
	private ToolEntry createPackage8CreationTool() {
		ArrayList<IElementType> types = new ArrayList<IElementType>(2);
		types.add(ComponentsElementTypes.Package_2001);
		types.add(ComponentsElementTypes.Package_3001);
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Package8CreationTool_title,
				Messages.Package8CreationTool_desc, types);
		entry.setId("createPackage8CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.Package_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createParameter9CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Parameter9CreationTool_title,
				Messages.Parameter9CreationTool_desc, Collections.singletonList(ComponentsElementTypes.Parameter_3005));
		entry.setId("createParameter9CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ComponentsElementTypes.getImageDescriptor(ComponentsElementTypes.Parameter_3005));
=======
