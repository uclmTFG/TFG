...
public class ComponentsElementTypes {
	...
	* @generated
	*/
	public static final IElementType Interface_2002 = getElementType("tfg.diagram.Interface_2002"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Enumeration_2003 = getElementType("tfg.diagram.Enumeration_2003"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Note_2004 = getElementType("tfg.diagram.Note_2004"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Property_3001 = getElementType("tfg.diagram.Property_3001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Method_3002 = getElementType("tfg.diagram.Method_3002"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Parameter_3003 = getElementType("tfg.diagram.Parameter_3003"); //$NON-NLS-1$
	/**
	* @generated
	*/
	...
	* @generated
	*/
	public static final IElementType EnumLiteral_3005 = getElementType("tfg.diagram.EnumLiteral_3005"); //$NON-NLS-1$
	/**
	* @generated
	*/
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Clas_2001, ComponentsPackage.eINSTANCE.getClas());

			elements.put(Interface_2002, ComponentsPackage.eINSTANCE.getInterface());

			elements.put(Enumeration_2003, ComponentsPackage.eINSTANCE.getEnumeration());

			elements.put(Note_2004, ComponentsPackage.eINSTANCE.getNote());

			elements.put(Property_3001, ComponentsPackage.eINSTANCE.getProperty());

			elements.put(Method_3002, ComponentsPackage.eINSTANCE.getMethod());

			elements.put(Parameter_3003, ComponentsPackage.eINSTANCE.getParameter());

			elements.put(Method_3004, ComponentsPackage.eINSTANCE.getMethod());

			elements.put(EnumLiteral_3005, ComponentsPackage.eINSTANCE.getEnumLiteral());
	...
	*/
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Note_2004);
			...
			KNOWN_ELEMENT_TYPES.add(EnumLiteral_3005);
