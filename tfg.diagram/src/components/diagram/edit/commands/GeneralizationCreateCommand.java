...
public class GeneralizationCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return ComponentsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateGeneralization_4001(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Generalization newElement = ComponentsFactory.eINSTANCE.createGeneralization();
