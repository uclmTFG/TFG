...
public class AssociationCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return ComponentsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateAssociation_4003(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Association newElement = ComponentsFactory.eINSTANCE.createAssociation();
