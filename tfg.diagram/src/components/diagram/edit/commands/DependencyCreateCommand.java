...
public class DependencyCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return ComponentsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateDependency_4006(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Dependency newElement = ComponentsFactory.eINSTANCE.createDependency();
