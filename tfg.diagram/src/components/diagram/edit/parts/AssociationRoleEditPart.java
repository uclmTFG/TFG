...
import components.diagram.edit.policies.ComponentsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AssociationRoleEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry.getType(components.diagram.edit.parts.AssociationRoleEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public AssociationRoleEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ComponentsTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Association_4003, getParserElement(),
					ComponentsVisualIDRegistry
							.getType(components.diagram.edit.parts.AssociationRoleEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ComponentsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
