...
public class PackageName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Package_3001, getParserElement(),
					ComponentsVisualIDRegistry.getType(components.diagram.edit.parts.PackageName2EditPart.VISUAL_ID));
		}
		return parser;
	}
