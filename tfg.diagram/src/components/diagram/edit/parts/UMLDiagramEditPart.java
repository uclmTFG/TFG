...
import components.diagram.edit.commands.ComponentsCreateShortcutDecorationsCommand;
import components.diagram.edit.policies.UMLDiagramCanonicalEditPolicy;
import components.diagram.edit.policies.UMLDiagramItemSemanticEditPolicy;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new ComponentsCreateShortcutDecorationsCommand(getEditingDomain(),
