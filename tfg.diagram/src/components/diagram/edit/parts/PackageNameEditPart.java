...
public class PackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Package_2001, getParserElement(),
					ComponentsVisualIDRegistry.getType(components.diagram.edit.parts.PackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
