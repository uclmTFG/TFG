 ...
 * @generated
 */
public class ClasNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
...
<<<<<<< HEAD
	...
	* @generated
	*/
	public ClasNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Clas_2002, getParserElement(),
=======
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Clas_2001, getParserElement(),
>>>>>>> branch 'master' of https://github.com/uclmTFG/TFG.git
					ComponentsVisualIDRegistry.getType(components.diagram.edit.parts.ClasNameEditPart.VISUAL_ID));
		}
		return parser;
	}
