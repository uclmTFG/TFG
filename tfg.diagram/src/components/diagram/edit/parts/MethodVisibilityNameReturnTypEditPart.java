 ...
 * @generated
 */
public class MethodVisibilityNameReturnTypEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MethodVisibilityNameReturnTypEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Method_3002, getParserElement(),
					ComponentsVisualIDRegistry
							.getType(components.diagram.edit.parts.MethodVisibilityNameReturnTypEditPart.VISUAL_ID));
		}
		return parser;
	}
