 ...
 * @generated
 */
public class PropertyVisibilityNameTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PropertyVisibilityNameTypeEditPart(View view) {
		super(view);
	}
