...
public class EnumerationName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Enumeration_3008, getParserElement(),
					ComponentsVisualIDRegistry
							.getType(components.diagram.edit.parts.EnumerationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
