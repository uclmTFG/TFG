...
<<<<<<< HEAD
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Enumeration_2004, getParserElement(),
=======
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Enumeration_2003, getParserElement(),
>>>>>>> branch 'master' of https://github.com/uclmTFG/TFG.git
					ComponentsVisualIDRegistry
							.getType(components.diagram.edit.parts.EnumerationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
