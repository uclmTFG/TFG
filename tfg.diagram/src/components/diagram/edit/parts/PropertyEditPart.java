...
import components.diagram.edit.policies.PropertyItemSemanticEditPolicy;
...
public class PropertyEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PropertyVisibilityNameTypeEditPart) {
			((PropertyVisibilityNameTypeEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ComponentsVisualIDRegistry.getType(PropertyVisibilityNameTypeEditPart.VISUAL_ID));
	}
