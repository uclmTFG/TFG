 ...
 * @generated
 */
public class NoteTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
...
<<<<<<< HEAD
	...
	* @generated
	*/
	public NoteTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Note_2005, getParserElement(),
=======
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Note_2004, getParserElement(),
>>>>>>> branch 'master' of https://github.com/uclmTFG/TFG.git
					ComponentsVisualIDRegistry.getType(components.diagram.edit.parts.NoteTextEditPart.VISUAL_ID));
		}
		return parser;
	}
