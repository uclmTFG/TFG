...
<<<<<<< HEAD
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Interface_2003, getParserElement(),
=======
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Interface_2002, getParserElement(),
>>>>>>> branch 'master' of https://github.com/uclmTFG/TFG.git
					ComponentsVisualIDRegistry.getType(components.diagram.edit.parts.InterfaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
