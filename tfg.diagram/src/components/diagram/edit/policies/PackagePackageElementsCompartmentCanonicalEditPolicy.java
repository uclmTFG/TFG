 ...
 * @generated
 */
public class PackagePackageElementsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getPackagePackageElementsCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getPackagePackageElementsCompartment_7001SemanticChildren((View) getHost().getModel());
