 ...
 * @generated
 */
public class PackagePackageElementsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentsPackage.eINSTANCE.getPackage_Elements();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getPackagePackageElementsCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getPackagePackageElementsCompartment_7002SemanticChildren((View) getHost().getModel());
