...
public class ComponentsNavigatorLabelProvider extends LabelProvider
	...
	*/
	public Image getImage(View view) {
		...
		case PackageEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?components?Package", ComponentsElementTypes.Package_2001); //$NON-NLS-1$
		case ClasEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?components?Clas", ComponentsElementTypes.Clas_2002); //$NON-NLS-1$
		case InterfaceEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?components?Interface", ComponentsElementTypes.Interface_2003); //$NON-NLS-1$
		case EnumerationEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?components?Enumeration", ComponentsElementTypes.Enumeration_2004); //$NON-NLS-1$
		case NoteEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?components?Note", ComponentsElementTypes.Note_2005); //$NON-NLS-1$
		case Package2EditPart.VISUAL_ID:
			return getImage("Navigator?Node?components?Package", ComponentsElementTypes.Package_3001); //$NON-NLS-1$
		case Clas2EditPart.VISUAL_ID:
			return getImage("Navigator?Node?components?Clas", ComponentsElementTypes.Clas_3002); //$NON-NLS-1$
		case PropertyEditPart.VISUAL_ID:
			return getImage("Navigator?Node?components?Property", ComponentsElementTypes.Property_3003); //$NON-NLS-1$
		...
		case ParameterEditPart.VISUAL_ID:
			return getImage("Navigator?Node?components?Parameter", ComponentsElementTypes.Parameter_3005); //$NON-NLS-1$
		case Interface2EditPart.VISUAL_ID:
			return getImage("Navigator?Node?components?Interface", ComponentsElementTypes.Interface_3006); //$NON-NLS-1$
		case Method2EditPart.VISUAL_ID:
			return getImage("Navigator?Node?components?Method", ComponentsElementTypes.Method_3007); //$NON-NLS-1$
		case Enumeration2EditPart.VISUAL_ID:
			return getImage("Navigator?Node?components?Enumeration", ComponentsElementTypes.Enumeration_3008); //$NON-NLS-1$
		case EnumLiteralEditPart.VISUAL_ID:
			return getImage("Navigator?Node?components?EnumLiteral", ComponentsElementTypes.EnumLiteral_3009); //$NON-NLS-1$
	...
	*/
	public String getText(View view) {
		...
		case ClasEditPart.VISUAL_ID:
			return getClas_2002Text(view);
		case InterfaceEditPart.VISUAL_ID:
			return getInterface_2003Text(view);
		case EnumerationEditPart.VISUAL_ID:
			return getEnumeration_2004Text(view);
		case NoteEditPart.VISUAL_ID:
			return getNote_2005Text(view);
		case Package2EditPart.VISUAL_ID:
			return getPackage_3001Text(view);
		case Clas2EditPart.VISUAL_ID:
			return getClas_3002Text(view);
		case PropertyEditPart.VISUAL_ID:
		...
		case Method2EditPart.VISUAL_ID:
			return getMethod_3007Text(view);
		case Enumeration2EditPart.VISUAL_ID:
			return getEnumeration_3008Text(view);
		case EnumLiteralEditPart.VISUAL_ID:
			return getEnumLiteral_3009Text(view);
		case GeneralizationEditPart.VISUAL_ID:
	...
	*/
	private String getPackage_2001Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Package_2001,
				view.getElement() != null ? view.getElement() : view,
				ComponentsVisualIDRegistry.getType(PackageNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
			ComponentsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5010); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	* @generated
	*/
	private String getClas_2002Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Clas_2002,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			ComponentsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5011); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getInterface_2003Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Interface_2003,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			ComponentsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5012); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	* @generated
	*/
	private String getEnumeration_2004Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Enumeration_2004,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			ComponentsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5013); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	* @generated
	*/
	private String getNote_2005Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Note_2005,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			ComponentsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5014); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	*/
	private String getPackage_3001Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Package_3001,
				view.getElement() != null ? view.getElement() : view,
				ComponentsVisualIDRegistry.getType(PackageName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	* @generated
	*/
	private String getClas_3002Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Clas_3002,
				view.getElement() != null ? view.getElement() : view,
				ComponentsVisualIDRegistry.getType(ClasName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	*/
	private String getProperty_3003Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Property_3003,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getParameter_3005Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Parameter_3005,
				view.getElement() != null ? view.getElement() : view,
	...
	*/
	private String getInterface_3006Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Interface_3006,
				view.getElement() != null ? view.getElement() : view,
				ComponentsVisualIDRegistry.getType(InterfaceName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	* @generated
	*/
	private String getMethod_3007Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Method_3007,
				view.getElement() != null ? view.getElement() : view,
	...
	* @generated
	*/
	private String getEnumeration_3008Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.Enumeration_3008,
				view.getElement() != null ? view.getElement() : view,
				ComponentsVisualIDRegistry.getType(EnumerationName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
					ParserOptions.NONE.intValue());
		} else {
	...
	* @generated
	*/
	private String getEnumLiteral_3009Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(ComponentsElementTypes.EnumLiteral_3009,
=======
import components.diagram.edit.parts.ClasEditPart;
import components.diagram.edit.parts.ClasNameEditPart;
import components.diagram.edit.parts.CompositionEditPart;
