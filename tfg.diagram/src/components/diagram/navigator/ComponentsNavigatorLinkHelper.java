 ...
 * @generated
 */
public class ComponentsNavigatorLinkHelper implements ILinkHelper {
	...
	*/
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = ComponentsDiagramEditorPlugin.getInstance().getDocumentProvider()
