...
/**
 * This is the item provider adapter for a {@link mof.Nodo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Nodo_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Nodo_color_feature", "_UI_Nodo_type"),
				 MofPackage.Literals.NODO__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
