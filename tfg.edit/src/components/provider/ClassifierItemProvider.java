...
/**
 * This is the item provider adapter for a {@link components.Classifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassifierItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComponentsPackage.Literals.CLASSIFIER__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComponentsPackage.Literals.CLASSIFIER__IS_ABSTRACT,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Classifier.class)) {
			case ComponentsPackage.CLASSIFIER__NAME:
			case ComponentsPackage.CLASSIFIER__IS_ABSTRACT:
