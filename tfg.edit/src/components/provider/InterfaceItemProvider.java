...
/**
 * This is the item provider adapter for a {@link components.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends ClassifierItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_stereotype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_stereotype_feature", "_UI_Interface_type"),
				 ComponentsPackage.Literals.INTERFACE__STEREOTYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentsPackage.Literals.INTERFACE__OPERATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ComponentsPackage.Literals.INTERFACE__OPERATIONS,
