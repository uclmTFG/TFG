...
public class ComponentsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComponentsPackage.UML_DIAGRAM: {
			...
			case ComponentsPackage.PACKAGE: {
				components.Package package_ = (components.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = caseClassifier(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComponentsPackage.CLAS: {
				Clas clas = (Clas)theEObject;
				T result = caseClas(clas);
				if (result == null) result = caseClassifier(clas);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComponentsPackage.INTERFACE: {
			...
			case ComponentsPackage.ENUMERATION: {
			...
			case ComponentsPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComponentsPackage.RELATIONSHIP: {
			...
			case ComponentsPackage.IMPLEMENTATION: {
			...
			case ComponentsPackage.COMPOSITION: {
			...
			case ComponentsPackage.DEPENDENCY: {
			...
			case ComponentsPackage.NOTE: {
				Note note = (Note)theEObject;
				T result = caseNote(note);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComponentsPackage.NOTE_LINK: {
				NoteLink noteLink = (NoteLink)theEObject;
				T result = caseNoteLink(noteLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePackage(components.Package object) {
=======
import components.*;
...
>>>>>>> branch 'master' of https://github.com/uclmTFG/TFG.git
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Note Link</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Note Link</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNoteLink(NoteLink object) {
		return null;
	}
