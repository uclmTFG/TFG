 ...
 * @generated
 */
public class TextIndexId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TextIndexId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TextIndexId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.TextIndex_2003, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TextIndexId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TextIndexLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TextIndexLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TextIndexLabelFigure() {
			this.setText("TextIndex");
		}
