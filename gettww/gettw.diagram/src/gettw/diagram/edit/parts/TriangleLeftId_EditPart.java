 ...
 * @generated
 */
public class TriangleLeftId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TriangleLeftId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TriangleLeftId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.TriangleLeft_2010, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TriangleLeftId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TriangleLeftLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TriangleLeftLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TriangleLeftLabelFigure() {
			this.setText("TriangleLeft");
		}
