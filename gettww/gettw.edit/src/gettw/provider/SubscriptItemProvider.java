...
/**
 * This is the item provider adapter for a {@link gettw.Subscript} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubscriptItemProvider extends TextItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subscript_subscript_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subscript_subscript_feature", "_UI_Subscript_type"),
				 GettwPackage.Literals.SUBSCRIPT__SUBSCRIPT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Subscript)object).getId_();
