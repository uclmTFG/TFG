...
/**
 * This is the item provider adapter for a {@link gettw.RoundedRectangle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoundedRectangleItemProvider extends ShapeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoundedRectangle_shape_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoundedRectangle_shape_feature", "_UI_RoundedRectangle_type"),
				 GettwPackage.Literals.ROUNDED_RECTANGLE__SHAPE,
				 false,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((RoundedRectangle)object).getId_();
