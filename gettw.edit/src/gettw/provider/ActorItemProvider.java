...
/**
 * This is the item provider adapter for a {@link gettw.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider extends ShapeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_shape_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_shape_feature", "_UI_Actor_type"),
				 GettwPackage.Literals.ACTOR__SHAPE,
				 false,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Actor)object).getId_();
