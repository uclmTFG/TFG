...
/**
 * This is the item provider adapter for a {@link gettw.Ellipse} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EllipseItemProvider extends ShapeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ellipse_shape_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ellipse_shape_feature", "_UI_Ellipse_type"),
				 GettwPackage.Literals.ELLIPSE__SHAPE,
				 false,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Ellipse)object).getId_();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Ellipse.class)) {
			case GettwPackage.ELLIPSE__SHAPE:
