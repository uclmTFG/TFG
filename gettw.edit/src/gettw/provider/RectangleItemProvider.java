...
/**
 * This is the item provider adapter for a {@link gettw.Rectangle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RectangleItemProvider extends ShapeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rectangle_shape_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rectangle_shape_feature", "_UI_Rectangle_type"),
				 GettwPackage.Literals.RECTANGLE__SHAPE,
				 false,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Rectangle)object).getId_();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Rectangle.class)) {
			case GettwPackage.RECTANGLE__SHAPE:
