...
/**
 * This is the item provider adapter for a {@link gettw.Triangle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriangleItemProvider extends ShapeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triangle_shape_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triangle_shape_feature", "_UI_Triangle_type"),
				 GettwPackage.Literals.TRIANGLE__SHAPE,
				 false,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Triangle)object).getId_();
		return label == null || label.length() == 0 ?
			getString("_UI_Triangle_type") :
			getString("_UI_Triangle_type") + " " + label;
	}
