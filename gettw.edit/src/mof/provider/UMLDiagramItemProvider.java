...
/**
 * This is the item provider adapter for a {@link mof.UMLDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UMLDiagramItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MofPackage.Literals.UML_DIAGRAM__NOTES);
			childrenFeatures.add(MofPackage.Literals.UML_DIAGRAM__NOTE_LINKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__ELEMENTS,
				 MofFactory.eINSTANCE.createInterface()));

		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__ELEMENTS,
				 MofFactory.eINSTANCE.createEnumeration()));
		...
		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__LINKS,
				 MofFactory.eINSTANCE.createImplementation()));

		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__LINKS,
				 MofFactory.eINSTANCE.createAssociation()));

		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__LINKS,
				 MofFactory.eINSTANCE.createAggregation()));

		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__LINKS,
				 MofFactory.eINSTANCE.createComposition()));

		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__LINKS,
				 MofFactory.eINSTANCE.createDependency()));

		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__NOTES,
				 MofFactory.eINSTANCE.createNote()));

		newChildDescriptors.add
			(createChildParameter
				(MofPackage.Literals.UML_DIAGRAM__NOTE_LINKS,
				 MofFactory.eINSTANCE.createNoteLink()));
	}
