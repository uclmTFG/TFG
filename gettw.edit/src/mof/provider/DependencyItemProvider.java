...
/**
 * This is the item provider adapter for a {@link mof.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider extends RelationshipItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_stereotype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_stereotype_feature", "_UI_Dependency_type"),
				 MofPackage.Literals.DEPENDENCY__STEREOTYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Dependency)object).getStereotype();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dependency.class)) {
			case MofPackage.DEPENDENCY__STEREOTYPE:
