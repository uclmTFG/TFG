 ...
 * @generated
 */
public class DiamondId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.DiamondId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public DiamondId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Diamond_2008, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.DiamondId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new DiamondLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DiamondLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DiamondLabelFigure() {
