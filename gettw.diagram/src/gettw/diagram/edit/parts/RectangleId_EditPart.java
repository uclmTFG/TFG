 ...
 * @generated
 */
public class RectangleId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.RectangleId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public RectangleId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Rectangle_2004, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.RectangleId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RectangleLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RectangleLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RectangleLabelFigure() {
