 ...
 * @generated
 */
public class TriangleId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TriangleId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TriangleId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Triangle_2007, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TriangleId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TriangleLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TriangleLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TriangleLabelFigure() {
