 ...
 * @generated
 */
public class SuperscriptId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.SuperscriptId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public SuperscriptId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Superscript_2001, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.SuperscriptId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SuperscriptLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SuperscriptLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SuperscriptLabelFigure() {
			this.setText("Superscript");
		}
