 ...
 * @generated
 */
public class PackageId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.PackageId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public PackageId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Package_2013, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.PackageId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PackageLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PackageLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PackageLabelFigure() {
			this.setText("Package");
		}
