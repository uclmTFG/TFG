...
import gettw.diagram.edit.policies.ActorItemSemanticEditPolicy;
...
public class ActorEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActorId_EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GettwVisualIDRegistry.getType(ActorId_EditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class ActorFigure extends gettw.figures.ActorFigure {
