 ...
 * @generated
 */
public class CustomLinkId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.CustomLinkId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CustomLinkId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.CustomLink_2014, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.CustomLinkId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CustomLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CustomLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CustomLinkLabelFigure() {
			this.setText("CustomLink");
		}
