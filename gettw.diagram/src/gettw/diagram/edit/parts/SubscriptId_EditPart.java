...
import gettw.diagram.edit.policies.GettwTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SubscriptId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.SubscriptId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public SubscriptId_EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new GettwTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Subscript_2002, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.SubscriptId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, GettwEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SubscriptLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SubscriptLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SubscriptLabelFigure() {
			this.setText("Subscript");
		}
