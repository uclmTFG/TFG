 ...
 * @generated
 */
public class TriangleRightId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TriangleRightId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TriangleRightId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.TriangleRight_2011, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TriangleRightId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TriangleRightLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TriangleRightLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TriangleRightLabelFigure() {
			this.setText("TriangleRight");
		}
