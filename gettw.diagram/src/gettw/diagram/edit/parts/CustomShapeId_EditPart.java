 ...
 * @generated
 */
public class CustomShapeId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.CustomShapeId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CustomShapeId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.CustomShape_2017, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.CustomShapeId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CustomShapeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CustomShapeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CustomShapeLabelFigure() {
			this.setText("CustomShape");
		}
