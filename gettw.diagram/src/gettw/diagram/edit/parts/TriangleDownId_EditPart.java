 ...
 * @generated
 */
public class TriangleDownId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TriangleDownId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TriangleDownId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.TriangleDown_2009, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TriangleDownId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TriangleDownLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TriangleDownLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TriangleDownLabelFigure() {
			this.setText("TriangleDown");
		}
