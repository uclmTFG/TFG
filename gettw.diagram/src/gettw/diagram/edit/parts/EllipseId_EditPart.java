 ...
 * @generated
 */
public class EllipseId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.EllipseId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public EllipseId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Ellipse_2006, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.EllipseId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EllipseLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EllipseLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EllipseLabelFigure() {
			this.setText("Ellipse");
		}
