 ...
 * @generated
 */
public class RoundedRectangleId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.RoundedRectangleId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public RoundedRectangleId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.RoundedRectangle_2005, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.RoundedRectangleId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RoundedRectangleLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RoundedRectangleLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RoundedRectangleLabelFigure() {
			this.setText("RoundedRectangle");
		}
