 ...
 * @generated
 */
public class ActorId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.ActorId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ActorId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Actor_2012, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.ActorId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ActorLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ActorLabelFigure extends WrappingLabel {
