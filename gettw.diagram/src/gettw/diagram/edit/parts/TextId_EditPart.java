 ...
 * @generated
 */
public class TextId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TextId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TextId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Text_2015, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.TextId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TextLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TextLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TextLabelFigure() {
			this.setText("Text");
		}
