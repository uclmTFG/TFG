 ...
 * @generated
 */
public class PictureId_EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.PictureId_EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public PictureId_EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GettwParserProvider.getParser(GettwElementTypes.Picture_2016, getParserElement(),
					GettwVisualIDRegistry.getType(gettw.diagram.edit.parts.PictureId_EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new PictureLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PictureLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public PictureLabelFigure() {
			this.setText("Picture");
		}
