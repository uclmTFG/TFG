 ...
 * @generated
 */
public class PackageTest extends ShapeTest {
	 ...
	 */
	@Override
	protected gettw.Package getFixture() {
		return (gettw.Package)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(GettwFactory.eINSTANCE.createPackage());
	}
