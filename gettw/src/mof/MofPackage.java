...
public interface MofPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int NODO_UNO__COLOR_BORDE = NODO__COLOR_BORDE;

	/**
	 * The feature id for the '<em><b>Nodos Dos</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int NODO_UNO__NODOS_DOS = NODO_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NODO_UNO_FEATURE_COUNT = NODO_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NODO_DOS__COLOR_BORDE = NODO__COLOR_BORDE;
	 ...
	 * @ordered
	 */
	int NODO_DOS__FORMA = NODO_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NODO_DOS__LINEA = NODO_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NODO_DOS_FEATURE_COUNT = NODO_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link mof.NodoUno#getNodosDos <em>Nodos Dos</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Nodos Dos</em>'.
	 * @see mof.NodoUno#getNodosDos()
	 * @see #getNodoUno()
	 * @generated
	 */
	EReference getNodoUno_NodosDos();
	...
	/**
	 * Returns the meta object for the attribute '{@link mof.NodoDos#getForma <em>Forma</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Forma</em>'.
	 * @see mof.NodoDos#getForma()
	 * @see #getNodoDos()
	 * @generated
	 */
	EAttribute getNodoDos_Forma();

	/**
	 * Returns the meta object for the attribute '{@link mof.NodoDos#getLinea <em>Linea</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Linea</em>'.
	 * @see mof.NodoDos#getLinea()
	 * @see #getNodoDos()
	 * @generated
	 */
	EAttribute getNodoDos_Linea();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Nodos Dos</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference NODO_UNO__NODOS_DOS = eINSTANCE.getNodoUno_NodosDos();
		 ...
		 * @generated
		 */
		EAttribute NODO_DOS__FORMA = eINSTANCE.getNodoDos_Forma();
		 ...
		 * @generated
		 */
		EAttribute NODO_DOS__LINEA = eINSTANCE.getNodoDos_Linea();
