 ...
 * </p>
 * <ul>
 *   <li>{@link mof.impl.AssociationImpl#getRole <em>Role</em>}</li>
 *   <li>{@link mof.impl.AssociationImpl#getSourceMultiplicity <em>Source Multiplicity</em>}</li>
 *   <li>{@link mof.impl.AssociationImpl#getTargetMultiplicity <em>Target Multiplicity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationImpl extends RelationshipImpl implements Association {
	...
	protected EClass eStaticClass() {
		return MofPackage.Literals.ASSOCIATION;
	}
	...
	public void setRole(String newRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MofPackage.ASSOCIATION__ROLE, oldRole, role));
	}
	...
	public void setSourceMultiplicity(String newSourceMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MofPackage.ASSOCIATION__SOURCE_MULTIPLICITY, oldSourceMultiplicity, sourceMultiplicity));
	}
	...
	public void setTargetMultiplicity(String newTargetMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MofPackage.ASSOCIATION__TARGET_MULTIPLICITY, oldTargetMultiplicity, targetMultiplicity));
	}
